...
const WordEditor = () => {
  ...
  const handleContentChange = (sceneIndex, contentIndex, field, value) => {
    ...
    setTimeout(() => {
      const textarea =
        inputRefs.current[`scene-${sceneIndex}-${field}-${contentIndex}`];
  ...
  const handleKeyDown = (event, sceneIndex, contentIndex) => {
    ...
    if (event.key === "Backspace" && input.value === "") {
      ...
      const allInputRefs = Object.keys(inputRefs.current).sort((a, b) => {
      ...
      setScenes((prevScenes) => {
        const newScenes = prevScenes.map((scene, idx) => {
          if (idx === sceneIndex) {
            const newContent = scene.content.filter(
              (_, i) => i !== contentIndex
            );
          ...
          prevScenes.map((scene, index) => {
            if (index === sceneIndex) {
              ...
              if (
                ...
                (selectedButton === "Dialog" && input.value.trim() !== "")
              ) {
        ...
        <div className="w-full  flex justify-center sticky top-5  z-50 ">
          <div className="flex justify-center w-[85%] lg:w-4/5 xl:w-[52%] 2xl:w-[45%]  border border-opacity-30  py-7 px-9 gap-4 bg-gray-100 border-black rounded-xl">
            ...
            <div className="flex flex-col w-1/3 2xl:w-1/3 space-y-4 ">
              <button
                className={`border border-black border-opacity-30 rounded-full px-4 py-2 ${
              ...
              <p className="text-center text-opacity-70 text-black">
                Press Keyboard Shift+Tab
              </p>
            </div>
        ...
        <div className="w-full flex justify-center">
          ...
          <div className="w-full  lg:w-4/5  px-4 md:px-8 lg:px-6 mt-4 lg:mt-7 flex flex-col space-y-8">
                ...
                <div className="w-full bg-pink-100 p-3 md:p-4 mb-6 rounded-md shadow-md">
                  <div className="flex items-center gap-2 justify-between mb-3">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleSceneTypeChange(scene.id, e.target.value)
                      }
                    >
                    ...
                    <input
                      ...
                      value={scene.title}
                      onChange={(e) =>
                        handleTitleChange(scene.id, e.target.value)
                      }
                    />
                  ...
                  <div className="mb-4 mt-4 flex items-center gap-2 flex-wrap">
                    <span className="text-xl md:text-xl font-medium">
                      Characters:
                    </span>
            ...
            <div className="mt-4 flex justify-center pb-8">
              ...
              >
                <span>
                  <MdOutlinePostAdd size={23} />
                </span>
                <span className="font-semibold mt-[6px] text-lg">
                  New Scene
                </span>
              </button>
            </div>
